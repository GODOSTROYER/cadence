...
Resolution-style guidance, necessary clarifications, social responses and handoffs are reported separately. Old scores keep their original definitions and policies. Common-policy rescoring and development ablations separate changed routing targets from changed behavior.

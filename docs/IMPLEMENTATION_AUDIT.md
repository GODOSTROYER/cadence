...
The practical submission improvement is to repair these claims, isolate immutable evidence, strengthen release checks, and run paired experiments on a fresh explicitly AI-reviewed sample. All 200 new messages initially received AI labels and individual rationales. **Arnav Bule has since completed human review of all 200 examples**, confirmed on 16 September 2026; see [review record](HUMAN_REVIEW.md). Judge–human agreement has not been measured. Neither AI–AI agreement nor order consistency substitutes for that measurement.
